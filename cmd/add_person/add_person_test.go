...
`
	...
	want := []*pb.Person_PhoneNumber{
		{Number: "123-456-7890", Type: pb.Person_PHONE_TYPE_HOME},
		{Number: "222-222-2222", Type: pb.Person_PHONE_TYPE_MOBILE},
		{Number: "111-111-1111", Type: pb.Person_PHONE_TYPE_WORK},
		{Number: "777-777-7777", Type: pb.Person_PHONE_TYPE_MOBILE},
	}
