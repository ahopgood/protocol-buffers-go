...
import (
	...
	pb "alexander.hopgood.com/protocol-buffers-go/alexander.hopgood.com/protocol-buffers-go/tutorial"
)
...
func TestListPeopleWritesList(t *testing.T) {
	...
	in := pb.AddressBook{People: []*pb.Person{
		...
		},
		{
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-555-5555", Type: pb.Person_PHONE_TYPE_WORK},
			},
		},
		{
			Name:  "Jack Buck",
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-555-0000", Type: pb.Person_PHONE_TYPE_HOME},
				{Number: "555-555-0001", Type: pb.Person_PHONE_TYPE_MOBILE},
				{Number: "555-555-0002", Type: pb.Person_PHONE_TYPE_WORK},
			},
		},
		{
			Name:  "Janet Doe",
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-777-0000"},
				{Number: "555-777-0001", Type: pb.Person_PHONE_TYPE_HOME},
			},
		},
	}}
	listPeople(buf, &in)
